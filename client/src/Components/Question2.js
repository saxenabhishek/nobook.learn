      ...
      >
        ...
        <div className="flex flex-col justify-center">
              ...
              onClick={()=>{setRepBtn('Reported')}}
                className="w-20 flex items-center justify-center px-5 border border-transparent text-base font-medium rounded-md text-white bg-red-500 hover:bg-red-800 md:py-4 md:text-lg md:px-10"
              >
                {repbtn}
              </button>
